...
export function rtlPage() {
  ...
  <div style="text-align:center"><svg class="t-icon t-icon--lg t-icon--directional" viewBox="0 0 20 20" fill="currentColor"><path d="M12 5 7 10l5 5V5z"/></svg><div class="t-body-sm t-tone-secondary" style="margin-block-start:5px">قرینه می‌شود</div></div>
  <div style="text-align:center"><svg class="t-icon t-icon--lg" viewBox="0 0 20 20" fill="currentColor"><path d="M10 17S3 12.5 3 7.8A3.6 3.6 0 0 1 10 6a3.6 3.6 0 0 1 7 1.8C17 12.5 10 17 10 17z"/></svg><div class="t-body-sm t-tone-secondary" style="margin-block-start:5px">نمی‌شود</div></div>
  <div style="text-align:center"><svg class="t-icon t-icon--lg" viewBox="0 0 20 20" fill="currentColor"><path d="M15 5h-2l-1.2-1.8H8.2L7 5H5a1.2 1.2 0 0 0-1.2 1.2v8.6A1.2 1.2 0 0 0 5 16h10a1.2 1.2 0 0 0 1.2-1.2V6.2A1.2 1.2 0 0 0 15 5zm-5 9a3.4 3.4 0 1 1 0-6.8 3.4 3.4 0 0 1 0 6.8z"/></svg><div class="t-body-sm t-tone-secondary" style="margin-block-start:5px">نمی‌شود</div></div>
