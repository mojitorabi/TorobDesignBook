    ...
    "specimens": [
      {
        ...
        "canvas": "plain",
        "stageClass": "spec__stage--center",
        "html": "<div style=\"position:relative;inline-size:375px;max-inline-size:100%;block-size:300px;border-radius:16px;overflow:hidden;border:1px solid var(--t-color-outline)\">\n  <div style=\"position:absolute;inset:0;background:var(--t-color-scrim)\"></div>\n  <div class=\"t-drawer\" style=\"position:absolute;animation:none;inline-size:240px\" role=\"dialog\" aria-modal=\"true\" aria-label=\"ناوبری\">\n    <div style=\"padding:14px 16px;border-block-end:1px solid var(--t-color-outline-subtle);font-weight:700\">پنل فروشنده</div>\n    <div style=\"padding:8px\">\n      <a class=\"t-nav-item\" href=\"#\" aria-current=\"page\">سفارش‌ها<span class=\"t-nav-item__count\">۳</span></a>\n      <a class=\"t-nav-item\" href=\"#\">محصولات<span class=\"t-nav-item__count\">۱۴۸</span></a>\n      <a class=\"t-nav-item\" href=\"#\">گزارش‌ها</a>\n    </div>\n  </div>\n</div>",
