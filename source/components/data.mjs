...
export default [
{
  ...
  anatomy: [
    ['ظرف', 'کادر مویی، گردی ۱۲، اسکرول در هر دو محور، سقف ارتفاع ۷۰ درصد کادر دید.', ':root'],
    ['هدر', 'چسبان بالا، زمینهٔ ملایم، ۱۲ پیکسل Bold، دکمهٔ مرتب‌سازی و <code>aria-sort</code> روی سرستون.', 'thead'],
    ['ردیف', 'هاور زمینهٔ ملایم؛ انتخاب‌شده زمینهٔ آبی ملایم و <code>aria-selected</code>.', 'tbody tr'],
    ['ستون عددی', '<code>.t-num</code> — تراز انتهای محور، ارقام جدولی، بدون شکست خط.', '.t-num'],
...
},
{
  ...
  anatomy: [
    ['برچسب', '۱۲ پیکسل ثانویه.', '.t-stat__label'],
    ['مقدار', '۲۴ پیکسل ExtraBold، جدولی.', '.t-stat__value'],
    ['دلتا', '۱۲ پیکسل با فلش و دوره؛ سبز، قرمز یا خنثی.', '.t-stat__delta'],
  ],
...
},
{
  ...
  anatomy: [
    ['برند', 'گوشهٔ بالای ابتدای محور، هم‌عرض نوار کناری.', '.t-shell__brand'],
    ['نوار بالا', 'جست‌وجو، اعلان، حساب کاربری.', '.t-shell__top'],
    ['نوار کناری', '۲۴۸ پیکسل، جمع‌شونده به ۶۰ پیکسل، اسکرول مستقل.', '.t-shell__nav'],
    ['محتوا', 'تنها ناحیهٔ اسکرول‌شوندهٔ اصلی.', '.t-shell__main'],
  ],
...
},
{
  ...
  anatomy: [
    ['برچسب', 'ستون اول، ثانویه، عرض بر پایهٔ بلندترین برچسب.', 'dt'],
    ['مقدار', 'ستون دوم، فام پیش‌فرض.', 'dd'],
  ],
