    ...
    "specimens": [
      {
        ...
        "canvas": "fog",
        "html": "<button class=\"t-button t-button--outline t-button--md\" onclick=\"torobToast({title:'به علاقه‌مندی‌ها اضافه شد',action:'واگرد'})\">Default + undo</button>\n<button class=\"t-button t-button--outline t-button--md\" onclick=\"torobToast({variant:'positive',title:'آدرس ذخیره شد',desc:'می‌توانید از حساب کاربری ویرایش کنید.'})\">Positive</button>\n<button class=\"t-button t-button--outline t-button--md\" onclick=\"torobToast({variant:'critical',title:'اتصال برقرار نشد',desc:'دوباره تلاش کنید.',action:'تلاش مجدد'})\">Critical</button>\n<button class=\"t-button t-button--outline t-button--md\" onclick=\"torobToast({variant:'caution',title:'موجودی این فروشگاه کم است'})\">Caution</button>"
      },
      {
        "label": "ساختار",
        "canvas": "plain",
    ...
    "specimens": [
      {
        ...
        "html": "<div style=\"position:relative;padding-block-start:38px\">\n  <span class=\"t-tooltip\" data-open=\"true\" role=\"tooltip\" id=\"tt1\" style=\"inset-block-start:0;inset-inline-start:50%;translate:50% 0\">خروجی اکسل</span>\n  <button class=\"t-icon-button\" aria-label=\"خروجی اکسل\" aria-describedby=\"tt1\"><svg class=\"t-icon\" viewBox=\"0 0 32 32\" fill=\"currentColor\" aria-hidden=\"true\"><path d=\"M26 24v4H6v-4H4v4a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2v-4zM26 14l-1.41-1.41L17 20.17V2h-2v18.17l-7.59-7.58L6 14l10 10 10-10z\"/></svg></button>\n</div>",
