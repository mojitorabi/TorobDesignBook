...
const PIN_BLUE = ['wcag', 'متن قرص قیمت در اسکچ Blue 500 است؛ روی سطح تیره ۲٫۷ به ۱ می‌شود و AA را رد می‌کند. کد در تم‌های تیره Blue 300 می‌گذارد (۵٫۶ به ۱ به بالا) و در روشن همان Blue 500 می‌ماند.'];
const GREY_TEXT = ['wcag', 'متن خاکستری کوچک (خط «از …»، فاصله، ناموجود) در اسکچ Sky 500 است؛ روی زمینهٔ خاکستری صفحه ۴٫۳ به ۱ می‌شود و AA را کمی رد می‌کند. کد Sky 600 می‌گذارد (۴٫۸ به ۱).'];
...
export const NOTES = {
  '1EA5654D-C993-4442-85A6-63FCFCE972B0': [PIN_BLUE],
  '65D3A449-8572-4EBF-9F05-78B63C752374': [PIN_BLUE],
  ...
  '010F7DA2-C959-4036-B6D1-E1A10BE1705F': [GREY_TEXT, BADGE_59, ['wcag', 'عنوان ۱۰ پیکسلی برای فارسی کوچک است. WCAG کمینهٔ اندازه ندارد، اما در ۱۰ پیکسل نقطه‌ها و دندانه‌ها گم می‌شوند؛ پیشنهاد: ۱۲.']],
  '811403E0-0303-4036-9872-91C4A192C1A5': [GREY_TEXT, ['source', 'نسخهٔ دوم Product Card/Small با همین نام.']],
  '641CDD78-38C5-4142-A597-74BBABBB77D6': [GREY_TEXT, YEKAN, BADGE_59],
